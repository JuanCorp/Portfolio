...
tipo_vivienda_map = {"apartment": "apartamentos", "house": "casas", "villas": "casas vacacionales y villas",
...
def get_price_prediction(request):
    ...
    low_prediction, high_prediction,alq_low,alq_high, explicacion_dict, explicacion_text = predict_price(prepared_data,
                                                                                        params_dict['Sector'])
    json_response = {
        ...
        'alquiler_low':format_currency(int(alq_low), 'USD', locale='en_US'),
        'alquiler_high': format_currency(int(alq_high), 'USD', locale='en_US'),
